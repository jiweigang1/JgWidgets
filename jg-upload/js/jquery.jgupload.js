			...
			var upload =	new AjaxUpload(this.element, {
								...
								onSubmit : function(file, ext){
									if(self.options.beforeUpload){
										self.options.beforeUpload.call(self.element,file, ext);
									}
								},
								onComplete: function(file, response){	
									if(self.options.onUpload){
										self.options.onUpload.call(self.element,file,response);
									}
								}
							});
    ...
    */
    ...
    AjaxUpload.prototype = {
        ...
        _rerouteClicks: function(){
            ...
            $(self._button).on('mouseover', function(){
                if (self._disabled){
                    return;
                }
